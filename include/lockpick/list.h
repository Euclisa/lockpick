...
void lp_list_insert_before(lp_list_t **head, lp_list_t *position, lp_list_t *entry);
void lp_list_insert_after(lp_list_t **head, lp_list_t *position, lp_list_t *entry);

void lp_list_push_back(lp_list_t **head, lp_list_t *entry);
void lp_list_push_front(lp_list_t **head, lp_list_t *entry);

void lp_list_remove(lp_list_t **head, lp_list_t *entry);
