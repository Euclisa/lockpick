...
def gen_cases_push_back(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_push_back.txt",'w') as f:
...
def gen_cases_push_front(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_push_front.txt",'w') as f:
        for case_i in range(cases_per_test):
...
def gen_cases_insert_before_head(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_insert_before_head.txt",'w') as f:
        for case_i in range(cases_per_test):
...
def gen_cases_insert_after_head(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_insert_after_head.txt",'w') as f:
        for case_i in range(cases_per_test):
...
def gen_cases_insert_before_tail(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_insert_before_tail.txt",'w') as f:
        for case_i in range(cases_per_test):
...
def gen_cases_insert_after_tail(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_insert_after_tail.txt",'w') as f:
        for case_i in range(cases_per_test):
...
def gen_cases_random(path,cases_per_test):
    curr_list = []
    with open(f"{path}/dlist_random.txt",'w') as f:
        for case_i in range(cases_per_test):
            if curr_list:
...
if __name__ == "__main__":
    ...
    arg_parser = argparse.ArgumentParser(description="lp_dlist test cases generator")
