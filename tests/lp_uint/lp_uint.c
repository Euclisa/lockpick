...
void test_uint_##N_a##_##N_b##_##N_result##_addition(lp_uint(N_a) *a_samples, lp_uint(N_b) *b_samples)                      \
{                                                                                                                           \
...
void test_uint_##N_a##_##N_b##_##N_result##_subtraction(lp_uint(N_a) *a_samples, lp_uint(N_b) *b_samples)                   \
{                                                                                                                           \
...
void test_uint_##N_a##_##N_b##_##N_result##_multiplication(lp_uint(N_a) *a_samples, lp_uint(N_b) *b_samples)                \
{                                                                                                                           \
    const char *fn_mul =                                                                                                    \
...
void test_uint_##N_a##_##N_b##_##N_result##_and(lp_uint(N_a) *a_samples, lp_uint(N_b) *b_samples)                           \
{                                                                                                                           \
    const char *fn_and =                                                                                                    \
...
void test_uint_##N_a##_##N_b##_##N_result##_ops_arithmetic(lp_uint(N_a) *a_samples, lp_uint(N_b) *b_samples)                \
{                                                                                                                           \
